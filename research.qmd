...
`r fa("book")` R Companion for Introduction to Econometrics (Stock and Watson, 4th Edition 2019) `r fa("calendar-days")` (Expected 2025) <br>
  with Assoc. Prof. Osman Dogan and Assoc. Prof. Suleyman Taspinar

`r fa("book")` Solution Manual for Book of Proof - Richard Hammack (3.4 Edition, 2025) `r fa("calendar-days")` (Expected 2025) <br>
  Progress: 95%
...
- **Research Assistant** to Asst. Prof. Umut Kuruüzüm `r fa("calendar-days")` (06/2024 - 09/2024) <br>
  Supply Chain Analysis of Cotton, in partnership with ICF and the U.S. Department of Labor.
  
- **Research Assistant** to Assoc. Prof. Aysun Hiziroglu Aygun `r fa("calendar-days")` (11/2022 - 11/2023)<br>
