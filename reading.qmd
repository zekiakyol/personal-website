...
These are the logos I designed for the reading groups that I organize.
...
The syllabuses and other details of our reading group are at [github.com/zekiakyol/proof-based-math-readings](https://github.com/zekiakyol/proof-based-math-readings)

::: {.d-flex .justify-content-between}
::: {}
`r fa("book")` Measure, Integration & Real Analysis - Sheldon Axler (1st Edition 2020) <br> <br>
